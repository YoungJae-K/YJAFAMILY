 ...
 * (http://www.no-margin-for-errors.com) Version: 3.1.2
 * -------------------------------------------------------------------------
 */
(function($) {
	$.prettyPhoto = {
	...
	$.fn.prettyPhoto = function(pp_settings) {
		...
		function _insert_gallery() {
			if (isSet
				...
				itemWidth = 52 + 5;
				navWidth = (settings.theme == "facebook" || settings.theme == "dark_rounded") ? 50
						: 30;
				itemsPerPage = Math
...
/*
 * Copyright (c) 2010 WordImpressed.com jFlow Plus derived from Kean Loong Tan's
 * orgininal jFlow http://www.wordimpressed.com Licensed under the MIT
 * (http://www.opensource.org/licenses/mit-license.php) jFlow 1.2 (Plus)
 * Version: jFlow Plus Requires: jQuery 1.2+
 */
(function($) {
	$.fn.jFlow = function(options) {
		...
		$(opts.slides).before(
				'<div id="' + jFS.substring(1, jFS.length) + '"></div>')
				.appendTo(jFS);
		$(opts.slides).find("div").each(
				function() {
...
/*
 * jQuery EasIng v1.1.2 - http://gsgd.co.uk/sandbox/jquery.easIng.php Uses the
 * built In easIng capabilities added In jQuery 1.1 to offer multiple easIng
 * options Copyright (c) 2007 George Smith Licensed under the MIT License:
...
/*
 * Superfish v1.4.8 - jQuery menu widget Copyright (c) 2008 Joel Birch Dual
 * licensed under the MIT and GPL licenses:
 * http://www.opensource.org/licenses/mit-license.php
 * http://www.gnu.org/licenses/gpl.html CHANGELOG:
